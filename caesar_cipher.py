...
\033[00m''')
	...
	def decision(self):
		dec = input("\n\nDo You Want To Encrypt [\033[1;32;48mE\033[00m] / Decrypt [\033[1;32;48mD\033[00m] /BruteForce [\033[1;32;48mB\033[00m] / Exit ---> ")
		if dec == 'E':
			print("\n\n[ :) ] Encrypting process Starting \... ( Press \033[1;32;48m99\033[00m to go back To main Menu )\n")
			time.sleep(1) #1
			self.encrypting()
			...
			print("\n\n[ :) ] BruteForcing process Starting \... ( Press \033[1;32;48m99\033[00m to go back To main Menu )\n")
			time.sleep(1)
			self.brute()
